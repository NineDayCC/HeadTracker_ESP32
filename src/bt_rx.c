...
#define GATTC_TAG "BT"
#define REMOTE_SERVICE_UUID        BT_HEADTRACKER_UUID_VALUE
#define REMOTE_NOTIFY_CHAR_UUID    BT_PWM_UUID_VALUE
...
static void notify_handle(uint8_t *data)
{
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_NOTIFY_EVT:
        ...
        notify_handle(p_data->notify.value);
        break;
